...
import { UpdatedUserResponse } from '../../interfaces/IUser';
...
const Payment = () => {
  ...
  const { mutate } = useMutation(
    () =>
      api.fetch<any>('update_user_role', {
        userId: loggedUser.user.id,
        userRole: UserRole.RegularRestaurantOwner,
      }),

    {
      onSuccess: (response: ApiResponse<UpdatedUserResponse>) => {
          ...
          <div className="mt-8 mx-6">
            <div className="mb-4 md:mb-6 my-8">
              ...
              <p className="md:block text-sm text-gray-500">
                All information should be provided in order to achieve
                successful payment.
              </p>
            </div>
