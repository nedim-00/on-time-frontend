...
import deleteOrderItem from '../../assets/images/restaurant/deletetable.png';
import { MenuItem, Restaurant } from '../../interfaces/IRestaurantDetails';
      ...
      {!loading && !notFound && restaurant && (
        <div className="text-left bg-[#FBFBF9]">
          ...
          <div className="mx-5 mt-3 ">
              ...
              <div className="title">
                ...
                <div className="text-xs font-normal text-[#9D9D9D]">
                  ...
                  {restaurant.municipality &&
                    enumKeys(Municipality)[restaurant.municipality - 1]}
                  {!restaurant.municipality &&
                  ...
                  <div className=" border-solid border-gray-300 border-[1px] rounded-[10px] ">
                    <div className="ml-[13px] flex flex-col gap-[25px] mt-2 mb-2 py-4">
                      ...
                      <div className="flex flex-col gap-[17px] ml-[16px]">
                        <p>
                          <b>MON - SUN | </b> {restaurant.openTime.slice(0, 5)}{' '}
                ...
                >
                  <form>
                    <div className="flex flex-col">
                      <div>
                        <div className="py-4 max-h-72 overflow-y-scroll scrollbar flex flex-wrap">
                          {restaurant?.menus[0].menuItems &&
                            restaurant?.menus[0].menuItems.map(
                              (menuItem: MenuItem, i) => (
                                <div
                                  key={menuItem.name}
            ...
            <div className="py-4 md:max-w-[400px]">
              <h2 className="text-xl mb-4">Menu</h2>
              <div className="mb-4 bg-white h-80 overflow-y-scroll scrollbar rounded-lg shadow-md py-4">
                {restaurant?.menus[0].menuItems &&
                  restaurant?.menus[0].menuItems.map(
                    (menuItem: MenuItem, i) => (
